...
import (
	...
	"github.com/Domains18/SIL-backend/internal/core/functions"
	"github.com/Domains18/SIL-backend/internal/core/models"
	"go.opentelemetry.io/otel"
)

type Handler struct {
	orderRepo    adapters.Order
	customerRepo adapters.Customer
}
...
func NewHandler(orderRepo adapters.Order, customerRepo adapters.Customer) *Handler {
	return &Handler{
		orderRepo:    orderRepo,
